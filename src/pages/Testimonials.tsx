...
const reviews = [
  { name: "Maria Santos", role: "ICU Nurse · Doha, Qatar", text: "From Prometric coaching to visa processing, Gulf Nurses handled everything. I landed my dream ICU role in Doha within four months.", rating: 5 },
