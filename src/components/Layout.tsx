...
const XIcon = ({ className }: { className?: string }) => (
  <svg viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden="true">
    <path d="M18.244 2H21l-6.51 7.44L22 22h-6.844l-4.77-6.231L4.8 22H2l6.96-7.953L2 2h6.91l4.31 5.7L18.244 2zm-1.198 18h1.83L7.06 4H5.1l11.946 16z"/>
  </svg>
);
        ...
        <div className="container py-14 grid md:grid-cols-2 lg:grid-cols-4 gap-10">
          <div>
            ...
            <div className="flex gap-2 mt-4">
              <a href="https://www.facebook.com/Ecdemserenityglobal" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="w-9 h-9 grid place-items-center rounded-full bg-background/10 hover:bg-primary transition-colors"><Facebook className="h-4 w-4" /></a>
